...
- **"Project"** means the Tiny Claw software and associated documentation maintained at [https://github.com/warengonzaga/tinyclaw](https://github.com/warengonzaga/tinyclaw).
...
- **(c)** If Your employer(s) has rights to intellectual property that You create that includes Your Contributions, You have received permission to make Contributions on behalf of that employer, or Your employer has waived such rights for Your Contributions to the Project.
- **(d)** You are legally entitled to grant the above licenses. If Your employer has rights to intellectual property that You create, You represent that You have received permission to make the Contributions on behalf of that employer, or that Your employer has waived such rights.
...
- **(c)** Ensure the third-party content is compatible with the GNU General Public License v3.0 (GPL-3.0).
...
**Version:** 1.0  
**Effective Date:** February 16, 2026  
**Maintainer:** Waren Gonzaga  
**License:** GNU General Public License v3.0 (GPL-3.0) + Commercial  
**Repository:** [https://github.com/warengonzaga/tinyclaw](https://github.com/warengonzaga/tinyclaw)
